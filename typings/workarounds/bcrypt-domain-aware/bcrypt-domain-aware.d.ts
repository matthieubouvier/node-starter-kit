// Typings copied (and modified: module name) from bcrypt because there is no typings for bcrypt-domain-aware
// We use bcrypt-domain-aware because of domain management

declare module "bcrypt-domain-aware" {
  /**
